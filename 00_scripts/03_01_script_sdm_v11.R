...
sa <- dplyr::bind_rows(rnaturalearth::ne_countries(scale = 50, country = "France"),
    rnaturalearth::ne_countries(scale = 50, continent = "South America")) %>% 
    sf::st_crop(rnaturalearth::ne_countries(scale = 50, continent = "South America"))
sa
...
## export ----
path_sp <- paste0("02_results/03_01_sdms_v11")
