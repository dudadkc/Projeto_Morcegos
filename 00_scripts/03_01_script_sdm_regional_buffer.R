...
# occ
occ <- readr::read_csv("01_data/00_occurrences/bats_literature.csv")
occ
...
# limit
li <- sf::st_read("01_data/01_variables/limit/neotropic_dissolved_fill_holes.shp")
li
...
# covar
covar <- terra::rast("01_data/01_variables/climate/wc_21_neotropic.tif")
covar
...
## export ----
path_sp <- paste0("02_models/03_01_sdms_teste1")
